...
///   i.e. they use themselves as the `SorobanArbitrary::Arbitrary` type,
...
mod objects {
    ...
    impl<const N: usize> SorobanArbitrary for BytesN<N> {
        type Arbitrary = ArbitraryBytesN<N>;
    }
    ...
    where
        T: SorobanArbitrary,
    {
        type Arbitrary = ArbitraryVec<T::Arbitrary>;
    }
    ...
    where
        ...
        V: SorobanArbitrary,
    {
        type Arbitrary = ArbitraryMap<K::Arbitrary, V::Arbitrary>;
    }
    ...
    impl SorobanArbitrary for Address {
        type Arbitrary = ArbitraryAddress;
    }
    ...
    impl SorobanArbitrary for AccountId {
        type Arbitrary = ArbitraryAccountId;
    }
...
mod composite {
    ...
    pub enum ArbitraryRawVal {
        ...
        //Address(<Address as SorobanArbitrary>::Arbitrary),
    }

    impl SorobanArbitrary for RawVal {
        type Arbitrary = ArbitraryRawVal;
    }
...
mod tests {
        ...
        T::Arbitrary: for<'a> Arbitrary<'a>,
    {
        ...
        for _ in 0..100 {
            ...
            let input = T::Arbitrary::arbitrary(&mut unstructured).expect("SorobanArbitrary");
